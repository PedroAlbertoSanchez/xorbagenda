...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `FK_emp_cat` FOREIGN KEY (`idCategoria`) REFERENCES `categorias` (`idcategorias`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `FK_emp_dep` FOREIGN KEY (`idDepartamento`) REFERENCES `departamentos` (`iddepartamento`) ON DELETE SET NULL ON UPDATE SET NULL
