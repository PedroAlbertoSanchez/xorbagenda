					...
					<div align="center">
						...
						<form:form action="save" method="post" modelAttribute="usuario">
								...
								<div align="center">
									<table width="900">
										...
										<tr>
											...
											<td><form:input path="fechaNacimiento" id="date"
													type="date" max="1979-12-31" /></td>
										</tr>
									</table>
								</div>
							</fieldset>
								...
								<div align="center">
									<table width="900">
										...
										<tr>
											...
											<td><form:select path="categoria" id="categoria"
													class="form-control input-sm">
							...
							<fieldset>
								<legend></legend>
								<div align="center">
									<input class="buttonAlta" type="submit" value="Guardar Registro">
